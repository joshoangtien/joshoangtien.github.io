...
var Default;
(function (Default) {
    Default["PIN"] = localStorage.getItem("PIN");
})(Default || (Default = {}));
var WeatherType;
...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
            ...
            desc: "Turn images into emojis",
            url: "https://joshoangtien.github.io/art-maker",
            image: "/resources/assets/images/art-maker.jpg",
        }, {
            id: 2,
            title: "Generator",
            desc: "Generate a random string",
            url: "https://joshoangtien.github.io/generator",
            image: "/resources/assets/images/generator.jpg",
        }, {
            id: 3,
            title: "Tech Library",
            desc: "Knowledge library",
            image: "/resources/assets/images/tech.jpg",
            url: "https://joshoangtien.github.io/tech",
        }, {
            id: 4,
            title: "Lamsaodecode",
            desc: "A place to share knowledge, experience,...",
            image: "/resources/assets/images/lamsaodecode.jpg",
            url: "https://www.lamsaodecode.dev/",
        }].map((restaurant) => {
            const styles = {
                backgroundImage: `url(${restaurant.image})`
            };
            return (React.createElement("a", { key: restaurant.id, className: "restaurant-card background-image", style: styles, href: restaurant.url, target: "_blank" },
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-gear", id: "restaurants-section", title: "Feature!" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
